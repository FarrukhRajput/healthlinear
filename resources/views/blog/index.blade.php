...
@section('content')
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-6">
                <img  width="520px" src="//i0.wp.com/post.healthline.com/wp-content/uploads/2021/06/The-Sustainable-Table-Editors-Letter-732x549-Thumbnail.png?w=1092" alt="" class="css-1u8c2i8">

                <a class="css-jtcg31" href="" >
                    Welcome to the Sustainable Table: A Letter from the Editor
                </a>
                <p class="css-dx2vkh">
                    <a class="css-2fdibo" href="" >
                        The Sustainable Table is Healthline's hub where environmental issues and nutrition meet. You can take steps right here, right now, to eat and live with the earth in mind — and encourage others to do…
                    </a>
                </p>
                <a href="#">READ MORE<span class="css-15xqzls icon-hl-arrow-right css-0"></span></a>
            ...
            <div class="col-6">
                <div class="row mb-4 ">
                    <div class="col-5">
                        <img width="185px" src="https://post.healthline.com/wp-content/uploads/2021/04/1044185-Im-a-Black-RD.-I-Want-to-Educate-White-People-on-Respecting-Cultural-Foodways_Thumbnail-1.jpg" alt="" class="css-1u8c2i8">
                    </div>

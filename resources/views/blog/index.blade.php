...
@section('content')
    ...
    <div class="container mt-5">
        ...
        <div class="row mt-">
            <div class="col-lg-6">
                <img  class="img-fluid" src="//i0.wp.com/post.healthline.com/wp-content/uploads/2021/06/The-Sustainable-Table-Editors-Letter-732x549-Thumbnail.png?w=1092" alt="" class="css-1u8c2i8">
